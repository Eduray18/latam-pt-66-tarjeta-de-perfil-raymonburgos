...
function render(variables = {}) {
  ...
  // 1. Lógica de la portada
  let cover = `<div class="cover"><img src="${variables.background}" /></div>`;
  if (variables.includeCover == false) cover = "<div class='cover'></div>";

  // 2. Limpieza de variables para que no aparezca "null" en pantalla
  // Si variables.name es null, ponemos "Your Name", etc.
  let name = variables.name || "Your Name";
  let lastName = variables.lastName || "Lastname";
  let role =
    variables.role == null || variables.role == "null"
      ? "Web Developer"
      : variables.role;
  let city =
    variables.city == null || variables.city == "null"
      ? "City"
      : variables.city;
  let country =
    variables.country == null || variables.country == "null"
      ? "Country"
      : variables.country;

  // 3. Inyectamos el HTML usando las variables dinámicas
